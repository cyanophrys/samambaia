...
import component from './smb-placeholder.css' with { type: 'css' };
...
export class SmbPlaceholder extends HTMLElement {
  #container;
  #heading;
  #description;
  #additionalContent;
...
customElements.define('smb-placeholder', SmbPlaceholder);
